...
public:
  ...
  virtual bool Evaluate(double const* const* x,
    ...
    private:
        mutable int  num_params_, horizon;
        mutable double residuum;
        mutable MatrixXd A_, B_,Bd_, Q_, Q_final_,  R_, R_delta_, disturbance_, insecure_, u_ss_, x_ss_, x0_, u_prev_, x_states, u, deriv_wrt_u, u_past, lambdas_x, lambdas_u,lambdas_u_ref, u_horizon, u_current;
